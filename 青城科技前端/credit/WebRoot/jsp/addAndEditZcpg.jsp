                  ...
                  <div class="col-lg-8">
                     <section class="panel">
                        ...
                        <div class="panel-body">
                           <div class="form">
                              <form class="cmxform form-horizontal tasi-form" method="post" action="<%=basePath%>zcpgAction_addOrUpdateZcpg">
                                 <input name="zcpgobj.id" type="hidden" value="${zcpg.id }">
                                 <input name="zcpgobj.pgrq" type="hidden" value="${zcpg.pgrq }">
                                 <div class="form-group col-lg-8">
                                    <label class="control-label col-lg-3">贷款申请ID：</label>
                                    <div class="col-lg-9">
                                    	<select name="zcpgobj.sqid" class="form-control m-bot15">
	                                    	<c:forEach items="${sqs }" var="obj">
	                                    		<option value="${obj.id }" <c:if test="${obj.id==zcpg.sqid }">selected="selected"</c:if>>${obj.id }</option>
	                                    	</c:forEach>
                                    	</select>
                                    </div>
                                 </div>
                                 <div class="form-group col-lg-8">
                                    <label class="control-label col-lg-3">评估金额：</label>
                                    <div class="col-lg-9">
                                       	<input class="form-control" name="zcpgobj.pgje" type="text" value="${zcpg.pgje }"/>
                                    </div>
                                 </div>
                                 <div class="form-group col-lg-8">
                                    <label class="control-label col-lg-3">评估公司：</label>
                                    <div class="col-lg-9">
                                       	<input class="form-control" name="zcpgobj.pggs" type="text" value="${zcpg.pggs }"/>
                                    </div>
                                 </div>
                                 <div class="form-group col-lg-8">
                                    <label class="control-label col-lg-3">存放单位：</label>
                                    <div class="col-lg-9">
                                       	<input class="form-control" name="zcpgobj.cfdd" type="text" value="${zcpg.cfdd }"/>
                                    </div>
                                 </div>

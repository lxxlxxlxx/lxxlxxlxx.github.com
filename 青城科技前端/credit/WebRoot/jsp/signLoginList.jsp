					...
					<div class="col-sm-12">
						<section class="panel">
			                <div class="panel-body">
			                  <a href="<%=basePath%>commonAction_beforeAddOrUpdate?uid=" class="btn btn-info"><i class="fa fa-plus"></i>&nbsp;&nbsp;添加用户信息</a>
			                </div>
		              </section>
					</div>
				</div>
                        ...
                        <table  class="display table table-striped table-advance table-hover table-bordered" id="hidden-table-info">
                           ...
                           <tbody>
                              <c:forEach items="${userList }" var="obj">
	                                  <c:if test="${obj.uname != 'admin'}">
	                              	 <tr>
                              	 		 <td>${obj.id }</td>
	                                	 <td>${obj.uname }</td>
	                                 	 <td>${obj.addtime }</td>
		                                 <td>
			                             	<a class="btn btn-primary btn-xs" href="<%=basePath%>commonAction_beforeAddOrUpdate?uid=${obj.id}"><i class="fa fa-pencil"></i></a>
...
<div class="modal fade" id="myModal2" >
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="<%=basePath%>commonAction_delete" method="post">
				<input type="hidden" name="uid" id="delid" value="">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	                 <h4 class="modal-title">确认删除该用户信息？</h4>
	            </div>

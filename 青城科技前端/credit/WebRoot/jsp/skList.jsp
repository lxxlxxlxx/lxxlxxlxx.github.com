				...
				<div class="col-sm-12">
					<section class="panel">
		                <div class="panel-body">
		                  <a href="<%=basePath%>skAction_beforeAddOrUpdateSk?skid=" class="btn btn-info"><i class="fa fa-plus"></i>&nbsp;&nbsp;添加收款信息</a>
		                </div>
	              </section>
				</div>
			</div>
                  ...
                  <div class="panel-body">
                     <div class="adv-table">
                        <table  class="display table table-striped table-advance table-hover table-bordered" id="hidden-table-info">
                           ...
                           <tbody>
                              <c:forEach items="${skList }" var="obj">
                              	 <tr>
                              	 	 <td>${obj.id }</td>
	                                 <td>${obj.zh }</td>
	                                 <td>${obj.zhm }</td>
	                                 ...
	                                 <td>${obj.czy }</td>
	                                 <td>
		                             	<a class="btn btn-primary btn-xs" href="<%=basePath%>skAction_beforeAddOrUpdateSk?skid=${obj.id}"><i class="fa fa-pencil"></i></a>
...
<div class="modal fade" id="myModal2" >
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="<%=basePath %>skAction_deleteSk" method="post">
				<input type="hidden" name="skDelId" id="delid" value="">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	                 <h4 class="modal-title">确认删除该收款信息？</h4>
	            </div>
